...
from api.common import _direct_http_formats, _is_twitter_or_x_source, _normalize_http_headers, extract_media
...
class TestApiHelpers(unittest.TestCase):
    ...
    def test_normalize_http_headers_returns_plain_dict(self):
        class HeaderLike:
            def items(self):
                return [('Referer', 'https://x.com/'), ('Origin', 'https://x.com')]

        self.assertEqual(_normalize_http_headers(HeaderLike()), {
            'Referer': 'https://x.com/',
            'Origin': 'https://x.com',
        })
